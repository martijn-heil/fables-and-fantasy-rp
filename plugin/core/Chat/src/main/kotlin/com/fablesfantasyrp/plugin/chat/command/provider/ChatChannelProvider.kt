...
import com.fablesfantasyrp.plugin.chat.frunBlocking
...
class ChatChannelProvider(private val server: Server) : Provider<ChatChannel> {
	...
	override fun get(arguments: CommandArgs, modifiers: List<Annotation>): ChatChannel {
		...
		return frunBlocking { ChatChannel.fromStringAliased(channelName, sender) ?: throw ArgumentParseException("Chat channel '$channelName' not found.") }
	}
