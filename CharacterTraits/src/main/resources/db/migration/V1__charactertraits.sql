...
INSERT INTO character_trait (id, description) VALUES ('arcane_initiate',
	'Players with this trait know the "Windblast" spell without needing to be a spellcaster');

INSERT INTO character_trait (id, description) VALUES ('nightseer',
	'Players with this trait get the night vision effect when entering dark spaces and during the night.');

INSERT INTO character_trait (id, description) VALUES ('strong',
	'Players with this trait get two extra points in the strength stat.');

INSERT INTO character_trait (id, description) VALUES ('companion',
	'Players with this trait get to choose a companion pet. It can be used in CRP and events.');

INSERT INTO character_trait (id, description) VALUES ('knowledgeable',
	'Players with this trait get two extra lvl 1 spell slots and one extra lvl 2 spell slot.');

INSERT INTO character_trait (id, description) VALUES ('night_lords',
	'Players with this trait have a +1 on all their stat rolls during the night');

INSERT INTO character_trait (id, description) VALUES ('swift',
	'Players with this trait can move 6+d6 (agility) instead of 4+d6 (agility) - Outside CRP, players with this trait get a permanent speed 1 boost. (Speed 2 on roads)');
...
INSERT INTO character_trait (id, description) VALUES ('deathspeaker',
	'Players with this trait can interact with Spirits and Corpses during events. Giving them vital information or treasure locations.');

INSERT INTO character_trait (id, description) VALUES ('heightened_senses',
...
INSERT INTO character_trait (id, description) VALUES ('sylvani_blooded',
	'Players with this trait can regrow limbs after losing them.');

INSERT INTO character_trait (id, description) VALUES ('aspect_of_liliths_veil',
...
INSERT INTO character_trait (id, description) VALUES ('aspect_of_the_emerald_dusk',
...
INSERT INTO character_trait (id, description) VALUES ('swift_learner',
	'Players with this trait require one less lesson/rp session per magic level before they may do their next bonding trial.');

INSERT INTO character_trait (id, description) VALUES ('painfully_average',
	'Players with this trait get two extra skill points which they can freely distribute.');

INSERT INTO character_trait (id, description) VALUES ('attian_heritage',
	'Players with this trait get an additional 2 HP.');

INSERT INTO character_trait (id, description) VALUES ('witch_hunter',
	'Players with this trait do 2 additional damage with melee attacks against spellcasters.');

INSERT INTO character_trait (id, description) VALUES ('spell_eater',
	'Players with this trait start with a spell-eating tome item. When entering combat with this item, the user may attempt to unbind enemy spells, even if they are not a spellcaster.');

INSERT INTO character_trait (id, description) VALUES ('horsemaster',
	'Players with this trait do 1 additional damage with the SWORD melee weapon when mounted on a horse. Additionally, the horse has 2 additional movement range.');

INSERT INTO character_trait (id, description) VALUES ('adaptive',
	'Once per battle, players with this trait may choose a stat modifier of their choice when rolling for any action during their turn.');

INSERT INTO character_trait (id, description) VALUES ('warden',
	'During combat, you may choose to be someone''s warden. If this player then takes damage within 3 blocks of you, you may choose to take this damage for them. If you do, roll a D20. On a 1-6, you fail to take the hit. On a 7-14, you take half the damage that was aimed at the target, on a 15-20, you take all the damage aimed at the target.');

INSERT INTO character_trait (id, description) VALUES ('stone_shaper',
	'Players with this trait can replace parts of their body with sandstone sculptures when lost. If they do, the body part becomes fully functional again after a month IC. Though the body part is and still looks like sandstone.');

INSERT INTO character_trait (id, description) VALUES ('desert_wanderer',
	'The food bar of players with this trait lowers significantly slower than usual.');

INSERT INTO character_trait (id, description) VALUES ('follower_of_akhmat',
...
INSERT INTO character_trait (id, description) VALUES ('sturdy',
	'Players with this trait get two extra points in the defence stat.');

INSERT INTO character_trait (id, description) VALUES ('enduring_as_rock',
...
INSERT INTO character_trait (id, description) VALUES ('too_angry_to_die',
...
INSERT INTO character_trait (id, description) VALUES ('profiteer',
	'Players with this trait generate a passive 5 Andros per online hour.');

INSERT INTO character_trait (id, description) VALUES ('magical_resilience',
	'Players with this trait may ignore spell effects if the effectiveness roll is below 12');

INSERT INTO character_trait (id, description) VALUES ('natural_sprinter',
	'Players with this trait may once per battle add 5 to their dash action range.');

INSERT INTO character_trait (id, description) VALUES ('naturally_stealthy',
...
INSERT INTO character_trait (id, description) VALUES ('bodily_resilience',
	'Players with this trait are immune to diseases and poison');

INSERT INTO character_trait (id, description) VALUES ('impossible_to_finish',
...
INSERT INTO character_trait (id, description) VALUES ('mulemaster',
...
INSERT INTO character_trait (id, description) VALUES ('they_wont_even_notice',
	'Players with this trait have a +3 bonus when rolling on the lockpick table.');

INSERT INTO character_trait (id, description) VALUES ('kick_em_in_the_shins',
	'Players with this trait have a +1 to melee attacks targeting medium or large targets.');

INSERT INTO character_trait (id, description) VALUES ('small_stomach',
	'Food regenerate double the food bar points when eaten by a player with this trait.');

INSERT INTO character_trait (id, description) VALUES ('savage_blows',
	'Players with this trait do 2 additional damage when striking a critical hit. (18+)');

INSERT INTO character_trait (id, description) VALUES ('frenzy',
...
INSERT INTO character_trait (id, description) VALUES ('spidah_ridah',
	'Players with this trait start with a spider mount. (Voras Pet)');

INSERT INTO character_trait (id, description) VALUES ('hulking_brute',
	'Players with this trait are considered LARGE creatures instead of MEDIUM.');

INSERT INTO character_trait (id, description) VALUES ('prophet_of_the_green_flame',
...
INSERT INTO character_trait (id, description) VALUES ('boss_skewer',
	'Players with this trait do D2 additional damage to Nation/settlement/claim leaders & stewards with melee weapons.');

INSERT INTO character_trait (id, description) VALUES ('great_hunter',
	'Players with this trait do D3 additional damage to creatures with the BEAST or ANIMAL tag.');

INSERT INTO character_trait (id, description) VALUES ('sneaky_stabba',
	'When initiating combat, the first round of attacks do 3 additional damage when they hit.');

INSERT INTO character_trait (id, description) VALUES ('mushroom_addict',
...
INSERT INTO character_trait (id, description) VALUES ('voidal_origins',
	'Players with this trait are immune to direct damage from voidal spells.');

INSERT INTO character_trait (id, description) VALUES ('bonding_skin',
	'Players with this trait heal 1 HP per combat round. - Outside CRP, players with this trait can regernate small wounds naturally without treatment. (Ex: Sword cuts, arrow hits)');

INSERT INTO character_trait (id, description) VALUES ('piercing_gaze',
	'Players with this trait are immune to the "blindness" status effect.');

INSERT INTO character_trait (id, description) VALUES ('missile_mirror',
...
INSERT INTO race_character_trait (race, character_trait_id) VALUES ('DARK_ELF', 'night_lords');
...
INSERT INTO race_character_trait (race, character_trait_id) VALUES ('WOOD_ELF', 'sylvani_blooded');
...
INSERT INTO race_character_trait (race, character_trait_id) VALUES ('HIGH_ELF', 'lightning_reactions');
...
INSERT INTO race_character_trait (race, character_trait_id) VALUES ('HIGH_ELF', 'dragon_lord');
...
INSERT INTO race_character_trait (race, character_trait_id) VALUES ('ATTIAN_HUMAN', 'intelligent');
...
INSERT INTO race_character_trait (race, character_trait_id) VALUES ('ATTIAN_HUMAN', 'spell_eater');
...
INSERT INTO race_character_trait (race, character_trait_id) VALUES ('KHADAN_HUMAN', 'painfully_average');
INSERT INTO race_character_trait (race, character_trait_id) VALUES ('KHADAN_HUMAN', 'stone_shaper');
INSERT INTO race_character_trait (race, character_trait_id) VALUES ('KHADAN_HUMAN', 'desert_wanderer');
...
INSERT INTO race_character_trait (race, character_trait_id) VALUES ('DWARF', 'strong');
...
INSERT INTO race_character_trait (race, character_trait_id) VALUES ('DWARF', 'profiteer');
...
INSERT INTO race_character_trait (race, character_trait_id) VALUES ('HALFLING', 'profiteer');
...
INSERT INTO race_character_trait (race, character_trait_id) VALUES ('HALFLING', 'sturdy');
...
INSERT INTO race_character_trait (race, character_trait_id) VALUES ('ORC', 'hulking_brute');
...
INSERT INTO race_character_trait (race, character_trait_id) VALUES ('GOBLIN', 'nightseer');
...
INSERT INTO race_character_trait (race, character_trait_id) VALUES ('TIEFLING', 'bonding_skin');
...
INSERT INTO race_character_trait (race, character_trait_id) VALUES ('TIEFLING', 'missile_mirror');
