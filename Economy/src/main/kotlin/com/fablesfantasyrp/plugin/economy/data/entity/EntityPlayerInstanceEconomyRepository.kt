...
class EntityPlayerInstanceEconomyRepository<C>(child: C)
	: MassivelyCachingEntityRepository<Int, PlayerInstanceEconomy, C>(child), PlayerInstanceEconomyRepository
