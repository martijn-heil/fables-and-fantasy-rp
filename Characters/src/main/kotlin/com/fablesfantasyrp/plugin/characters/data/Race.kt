...
enum class Race(private val displayName: String, val boosters: CharacterStats) {
	ATTIAN_HUMAN("Attian Human", CharacterStats(strength = 1U, defense = 1U, agility = 1U)),
	HINTERLANDER_HUMAN("Hinterlander Human", CharacterStats(strength = 1U, defense = 1U, agility = 1U)),
	KHADAN_HUMAN("Khadan Human", CharacterStats(strength = 1U, defense = 1U, agility = 1U)),
